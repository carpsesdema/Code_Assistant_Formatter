...
"""
QThread subclasses for performing background tasks like file scanning
and find/replace/format operations, preventing UI freezes.
"""
...
# Import the ruff formatting function and utility functions
    ...
    def run(self):
        ...
        for idx, file_path in enumerate(self.files_to_process):
            ...
            try:
                 ...
                 if format_error_msg:
                     # Append format error to log, but keep the modified content
                     ...
                     final_content_to_write = modified_content # Keep modified, skip formatting result
                 else:
                 ...
                 final_content_to_write = modified_content # Revert to pre-format content
